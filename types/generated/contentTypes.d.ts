...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    direct_link: Schema.Attribute.String;
...
export interface ApiSidebarInfoSidebarInfo extends Struct.SingleTypeSchema {
  collectionName: 'sidebar_infos';
  info: {
    description: '';
    displayName: 'Sidebar Info';
    pluralName: 'sidebar-infos';
    singularName: 'sidebar-info';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    activeTabImages: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    birthday: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'2001-09-09'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sidebar-info.sidebar-info': ApiSidebarInfoSidebarInfo;
